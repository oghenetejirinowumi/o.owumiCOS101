...
fn main() {
    ...
    if input1 == trampezium_formula {
        ...
        let radiusc:f64 = input("Enter radius of cylinder");

        let mut heightc = input("Enter height of cylinder");
...
fn input(msg: &str) -> f64 {
    ...
    let input_num:u32 = input_str.trim().parse().expect("Not a valid entry");
    return input_num as f64;
}
